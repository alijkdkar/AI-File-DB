...
from Models.FileViewModels import UPLOAD_FOLDER,ARCHAVE_FILE,UPLOAD_THUMBNAIL_FOLDER,UPLOAD_FACES_FOLDER,ALLOWED_EXTENSIONS_MAGIC_NUMBER,ARCHIVE_PASSWORD,ALLOWED_EXTENSIONS,UPLOAD_HASHED_FOLDER
...
app.config['UPLOAD_HASHED_FOLDER'] = UPLOAD_HASHED_FOLDER
